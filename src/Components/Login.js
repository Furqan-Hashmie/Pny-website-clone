...
validationSchema: Yup.object({
  ...
  return (
    <div className=' back-color'>
     <center><button className='btn btn-dark mt-4 w-50 rounded'><h2>Signup Now</h2></button></center>
                ...
                <div className='my-4'>
                 ...
                 <div className="mb-3">
                    ...
                    <div className="mb-3 form-check radio">
                        ...
                        <label className="form-check-label " htmlFor="exampleCheck1"><b>I agree the term and policies</b></label>
                    </div>

                    <div className='d-flex mx-5'>
                        <button type="submit" className="btn btn-warning submitbtn mt-2"><b>Submit</b></button>
